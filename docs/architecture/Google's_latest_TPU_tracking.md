...
### TPUv4
据TPUv3时隔四年后，终于发布了TPUv4的版本。尽管这段时间里Google在AI领域发表了许多重要的成果，但似乎一直没有对TPU进行更新，这也导致了在2023年和2024年间，Google的TPU芯片在与NVIDIA和AMD等竞争对手的竞争中处于劣势，进一步导致当时其AI模型的竞争力与OpenAI，Meta等顶级AI公司拉开了差距但是仍然在之后的两年内(2024-2025)追赶上并达到世界顶级;这与其全栈自研的能力和恐怖的工程能力密不可分。
